...
export class OptionComponent implements OnInit {
         ...
         */
        refreshBackup(): void {
                this.optionService.getBackup()
                .subscribe(this.setBackup.bind(this));
        }
         ...
         */
        setBackup(backup: Array<Backup>): void {
        ...
        reduceVolume(): void {
                ...
                this.optionService.setVolume(this.currentVolume)
                .subscribe(
                        success => {
                                this.refreshVolume();
                        },
